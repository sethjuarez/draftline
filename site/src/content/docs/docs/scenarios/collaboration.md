...
description: Publish, receive, adopt, diagnose, and reconcile shared team work.
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 3
---

> **Scenario lens:** These flows protect teammate work by fetching first and requiring explicit reconciliation for divergence.
