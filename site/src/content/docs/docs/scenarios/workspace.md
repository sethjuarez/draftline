---
title: Workspace setup scenarios
description: Start, open, adopt, share, clone, and agent-facing workspace setup flows.
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 3
---

> **Scenario lens:** These flows define how Draftline establishes a safe workspace before any content-changing operation runs.
